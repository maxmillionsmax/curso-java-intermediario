...
public class Aula93DatasJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDate.of(2022, 01, 02));
		System.out.println(LocalDate.parse("2022-12-01"));
		...
		System.out.println(LocalDateTime.of(2022,2,16,20,25,10));
		System.out.println(LocalDateTime.parse("2022-02-16T20:25:10"));
		System.out.println(agoraCompleto.plusYears(37));
		...
		ZonedDateTime zdt = ZonedDateTime.of(LocalDateTime.parse("2022-02-16T20:25:10"), sp);
		System.out.println(zdt);
		System.out.println(ZonedDateTime.parse("2022-02-16T20:25:10-03:00[America/Sao_Paulo]"));
